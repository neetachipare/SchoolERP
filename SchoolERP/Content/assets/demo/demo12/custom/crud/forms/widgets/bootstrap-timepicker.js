var BootstrapTimepicker = {
    init: function () {
        $("#m_timepicker_1, #m_timepicker_1_modal").timepicker(),
            $("#m_timepicker_2, #m_timepicker_1_modal").timepicker(),
            $("#m_timepicker_3, #m_timepicker_1_modal").timepicker(),
            $("#m_timepicker_4, #m_timepicker_1_modal").timepicker(),
            $("#m_timepicker_5, #m_timepicker_1_modal").timepicker(),
            $("#m_timepicker_6, #m_timepicker_1_modal").timepicker(),
            $("#m_timepicker_7, #m_timepicker_1_modal").timepicker(),
            $("#m_timepicker_8, #m_timepicker_1_modal").timepicker(),
            $("#m_timepicker_9, #m_timepicker_1_modal").timepicker()
